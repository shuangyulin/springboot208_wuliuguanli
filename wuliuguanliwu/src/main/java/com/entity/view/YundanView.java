 ...
 */
@TableName("yundan")
public class YundanView extends YundanEntity implements Serializable {
	...
	public YundanView(YundanEntity yundanEntity) {
		try {
			BeanUtils.copyProperties(this, yundanEntity);
