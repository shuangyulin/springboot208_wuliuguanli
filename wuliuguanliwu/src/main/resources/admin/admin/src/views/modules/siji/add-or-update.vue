               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="司机姓名" prop="sijiName">
                       <el-input v-model="ruleForm.sijiName"
                                 placeholder="司机姓名" clearable  :readonly="ro.sijiName"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.sijiPhoto" label="头像" prop="sijiPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.sijiPhoto?ruleForm.sijiPhoto:''"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系方式" prop="sijiPhone">
                       <el-input v-model="ruleForm.sijiPhone"
                                 placeholder="联系方式" clearable  :readonly="ro.sijiPhone"></el-input>
                   </el-form-item>
                   <div v-else>
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`siji/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.sijiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
