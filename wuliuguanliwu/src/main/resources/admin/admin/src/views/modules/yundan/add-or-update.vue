    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="送货地点" prop="yundanAddress">
                       <el-input v-model="ruleForm.yundanAddress"
                                 placeholder="送货地点" clearable  :readonly="ro.yundanAddress"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="送货地点" prop="yundanAddress">
                           <el-input v-model="ruleForm.yundanAddress"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="收件人" prop="yundanName">
                       <el-input v-model="ruleForm.yundanName"
                                 placeholder="收件人" clearable  :readonly="ro.yundanName"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系方式" prop="yundanPhone">
                       <el-input v-model="ruleForm.yundanPhone"
                                 placeholder="联系方式" clearable  :readonly="ro.yundanPhone"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="运单状态" prop="yundanStatusTypes">
                        <el-select v-model="ruleForm.yundanStatusTypes" :disabled="ro.yundanStatusTypes" placeholder="请选择运单状态">
                            <el-option
                                v-for="(item,index) in yundanStatusTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="运单状态" prop="yundanStatusValue">
                        <el-input v-model="ruleForm.yundanStatusValue"
                            placeholder="运单状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   yundanStatusTypes: [
                              { required: true, message: '运单状态不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yundan_status_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yundanStatusTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`yundan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yundanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
