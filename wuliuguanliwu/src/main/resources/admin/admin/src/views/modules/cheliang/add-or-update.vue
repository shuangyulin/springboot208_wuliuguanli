        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="车辆状态" prop="cheliangStatusTypes">
                        <el-select v-model="ruleForm.cheliangStatusTypes" :disabled="ro.cheliangStatusTypes" placeholder="请选择车辆状态">
                            <el-option
                                v-for="(item,index) in cheliangStatusTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else>
                        <el-form-item class="input" label="车辆状态" prop="cheliangStatusValue">
                        <el-input v-model="ruleForm.cheliangStatusValue"
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=cheliang_status_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.cheliangStatusTypesOptions = data.data.list;
                    }
                });
